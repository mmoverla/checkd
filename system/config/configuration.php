...
define("DB_SERVER", "137.135.241.244");										// server name set here
define("DB_USERNAME", "indianic");								// server username set here
define("DB_PASSWORD", "ind@nic701");								// server password set here
define("DB_DATABASE", "checkd_final");	
...
define("DEMO_CHECKLIST1_ID",'177'); // general message for event panel
define("DEMO_CHECKLIST2_ID",'204');

// default latitude, longitude and location for project
define("DEFAULT_LATITUDE", '59.9111');
define("DEFAULT_LONGITUDE", '10.7333');
define("DEFAULT_LOCATION", 'Oslo, Norway');
